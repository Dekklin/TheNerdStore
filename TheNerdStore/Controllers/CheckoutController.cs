...
namespace PuffyAmiYumi.Controllers
{
    ...
    public class CheckoutController : Controller
    {
        ...
        public CheckoutController(IConfiguration config, IDevCarts cart, IDevOrders context, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager)
        {
            _config = config;
            _cart = cart;
            _context = context;
